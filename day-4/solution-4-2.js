...
const unmarkedNumbers = winningBoards[winningBoards.length - 1].flatMap(i => i).filter(number => !neededNumbers.includes(number))
      ...
      board.forEach((row, rowIdx) => {
        ...
        if (colIdx > -1) {
          ...
          if (
            ...
            winningBoards.push(boards[idx])
            board.boardHasWon = true
          }
        }
      })
    }
